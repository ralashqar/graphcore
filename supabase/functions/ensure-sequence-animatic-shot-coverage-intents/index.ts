...
import {
  CoverageIntentHttpError,
  runSequenceAnimaticShotCoverageIntentsCommand,
} from '../_shared/sequence-animatic-shot-coverage-intents-command.ts'
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const body = await runSequenceAnimaticShotCoverageIntentsCommand({
