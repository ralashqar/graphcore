...
const schema = z.object({ projectId: z.string().uuid(), draftId: z.string().uuid(), buildId: z.string().uuid().optional(), jobId: z.string().uuid().optional(), nodeId: z.string().max(64).optional() }).strict()
