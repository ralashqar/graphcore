...
import { runSequenceAnimaticShotProductionGraphCommand } from '../_shared/sequence-animatic-shot-production-graph-command.ts'
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const body = await runSequenceAnimaticShotProductionGraphCommand({
