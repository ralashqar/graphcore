...
import { runSequenceAnimaticBlockWorkflowCommand } from '../_shared/sequence-animatic-block-workflow-command.ts'
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const body = await runSequenceAnimaticBlockWorkflowCommand({
