...
import { runSequenceAnimaticContinuityWorkflowCommand } from '../_shared/sequence-animatic-continuity-workflow-command.ts'
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const body = await runSequenceAnimaticContinuityWorkflowCommand({
