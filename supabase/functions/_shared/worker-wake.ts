export type WorkerWakeFamily = 'visual' | 'output_workflow' | 'generation' | 'app_generation' | 'city_setup'

export const workerWakeFamilies: WorkerWakeFamily[] = ['visual', 'output_workflow', 'generation', 'app_generation', 'city_setup']
