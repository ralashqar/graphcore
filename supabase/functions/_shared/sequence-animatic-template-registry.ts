...
export const sequenceAnimaticShotProductionTemplateInputSchema = z.object({
  ...
  dependencyMode: z.literal('ingredient_refs').optional(),
...
>({
  ...
  policyVersion: 'sequence_animatic_shot_video_graph_v3_named_director_prompt',
  workflowFamily: 'sequence_animatic',
  commandAction: 'generate_shot_video',
  sourceHashKeys: ['draftId', 'commonConfig', 'shot', 'panel', 'assetPack', 'shotVideoReferenceOverride', 'editorialDurationSeconds', 'providerDurationSeconds', 'aspectRatio'],
  graphStages: ['shot_input', 'shot_video_reference_pack', 'shot_video_prompt_plan', 'shot_video_prompt', 'shot_video', 'shot_video_artifact'],
  requiredNodePurposes: [
    'sequence_animatic_shot_input',
  ...
  sourceHash: (input) => templateSourceHash('sequence_animatic_shot_video_graph_v3_named_director_prompt', input),
})
