...
try{
 ...
 for(const p of presets){
  await page.getByRole('button',{name:'Build',exact:true}).click();await page.getByRole('button',{name:'Blender collection',exact:true}).click();
 ...
 await page.getByRole('button',{name:'Paint',exact:true}).click();await page.getByRole('button',{name:'Openings',exact:true}).click();await page.getByRole('button',{name:'Cottage shutters',exact:true}).waitFor();
 await page.getByRole('button',{name:'Decorate',exact:true}).click();await page.getByRole('button',{name:'Civic dentil cornice',exact:true}).waitFor();
 await page.getByRole('button',{name:'Build',exact:true}).click();await page.getByRole('button',{name:'Select',exact:true}).click();
