...
const directory='output/game-mechanics-authoring',design=createUnified('exploration'),projectId=crypto.randomUUID(),draftId=crypto.randomUUID()
...
try{
 ...
 await page.getByText('fixed facing displacement',{exact:false}).first().waitFor()
