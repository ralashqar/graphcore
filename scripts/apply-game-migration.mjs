...
const selectedVersion=process.argv.includes('--studio-uncapped')?'20260913003652':process.argv.includes('--studio-budget')?'20260913000320':process.argv.includes('--animation-flexible')?'20260912132026':process.argv.includes('--animation-studio')?'20260912123937':process.argv.includes('--motion-sets')?'20260909214012':process.argv.includes('--mechanics')?'20260909140823':process.argv.includes('--animation-permissions')?'20260909072525':version
const selectedName=process.argv.includes('--studio-uncapped')?'animation_studio_remove_setup_cap':process.argv.includes('--studio-budget')?'animation_studio_additional_budget':process.argv.includes('--animation-flexible')?'animation_studio_flexible':process.argv.includes('--animation-studio')?'animation_studio':process.argv.includes('--motion-sets')?'game_motion_sets':process.argv.includes('--mechanics')?'game_mechanic_composition':process.argv.includes('--animation-permissions')?'game_animation_service_permissions':name
