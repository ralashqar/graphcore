...
const cinematicSequenceContracts = [
  {
    purpose: 'director_workspace', label: 'Director Workspace', requiredInputs: [],
  ...
  },
  {
    ...
    requiredInputs: ['screenplay'],
    producedOutputs: ['text', 'screenplay', 'screenplayDraft', 'screenplay_draft', 'qualityPass', 'quality_pass', 'findings'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Checking screenplay taste and continuity',
  ...
  },
  {
    ...
    label: 'Vibe Scene Shot Quality',
    requiredInputs: ['scene_plan'],
    producedOutputs: ['text', 'scenePlan', 'scene_plan', 'sceneShotPlan', 'scene_shot_plan', 'shotContinuityPlan', 'shot_continuity_plan', 'directorPlan', 'director_plan', 'qualityPass', 'quality_pass', 'shotDirections', 'shot_directions'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Checking shot taste and direction',
    providerBacked: false,
    manualOnly: false,
  },
  {
  ...
  },
  {
    ...
    label: 'Fix Shot References',
    requiredInputs: ['shot', 'asset_pack'],
    producedOutputs: ['text', 'shot', 'asset_pack', 'fixedReferences', 'fixed_references', 'referenceAssetKeys', 'reference_asset_keys', 'referenceImages', 'reference_images', 'referenceFixDecisions', 'reference_fix_decisions', 'referenceFixDiagnostics', 'reference_fix_diagnostics', 'referenceFixPatch', 'reference_fix_patch'],
    artifactRoles: [],
    previewRoles: ['text', 'referenceImages'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Fixing shot references',
    providerBacked: true,
    manualOnly: false,
  },
  {
    purpose: 'sequence_animatic_shot_reference_fix_apply',
    label: 'Apply Reference Fix',
    requiredInputs: ['shot', 'fixed_references', 'asset_pack'],
    producedOutputs: ['text', 'shot', 'asset_pack', 'fixedReferences', 'fixed_references', 'references', 'referenceAssetKeys', 'reference_asset_keys', 'referenceImages', 'reference_images', 'referenceFixDecisions', 'reference_fix_decisions', 'referenceFixDiagnostics', 'reference_fix_diagnostics', 'referenceFixPatch', 'reference_fix_patch'],
    artifactRoles: [],
    previewRoles: ['text', 'referenceImages'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Saving fixed references',
    providerBacked: false,
    manualOnly: false,
  },
  {
    purpose: 'sequence_animatic_previous_keyframe_grid',
    label: 'Previous Keyframes Grid',
    requiredInputs: [],
    producedOutputs: ['text', 'reference', 'references', 'referenceAssetKeys', 'reference_asset_keys', 'referenceImages', 'reference_images', 'previousKeyframeGrid', 'previous_keyframe_grid', 'asset_pack', 'image', 'keyframe', 'artifact', 'assetKey'],
    artifactRoles: ['sequence_animatic_previous_keyframe_grid'],
    previewRoles: ['referenceImages', 'image', 'text'],
    recoveryStrategy: 'node_step_artifact',
    progressLabel: 'Building previous keyframe grid',
    providerBacked: false,
    manualOnly: false,
  },
  {
  ...
  },
  {
    ...
    label: 'Keyframe Prompt Plan',
    requiredInputs: ['shot', 'asset_pack'],
    producedOutputs: ['text', 'prompt', 'shot', 'asset_pack', 'referenceAssetKeys', 'reference_asset_keys', 'referenceManifest', 'reference_manifest', 'promptPlan', 'prompt_plan', 'promptPlanDiagnostics', 'prompt_plan_diagnostics'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Planning keyframe prompt',
    providerBacked: true,
    manualOnly: false,
  },
  {
    purpose: 'vibe_director_continuity_preflight',
    label: 'Vibe Continuity Preflight',
    requiredInputs: ['shot', 'asset_pack'],
    producedOutputs: ['text', 'shot', 'assetPack', 'asset_pack', 'referenceAssetKeys', 'reference_asset_keys', 'referenceManifest', 'reference_manifest', 'continuityReadiness', 'continuity_readiness', 'shotDirection', 'shot_direction'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Checking shot reference readiness',
    providerBacked: false,
    manualOnly: false,
  },
  {
    ...
    requiredInputs: ['shot', 'asset_pack'],
    producedOutputs: ['text', 'prompt', 'shot', 'coverageAnchor', 'coverage_anchor', 'asset_pack', 'referenceAssetKeys', 'reference_asset_keys', 'promptPlan', 'prompt_plan', 'promptPlanDiagnostics', 'prompt_plan_diagnostics'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
  ...
  },
  {
    ...
    label: 'Vibe Keyframe Prompt Quality',
    requiredInputs: ['prompt'],
    producedOutputs: ['text', 'prompt', 'shot', 'assetPack', 'asset_pack', 'referenceAssetKeys', 'reference_asset_keys', 'referenceManifest', 'reference_manifest', 'continuityReadiness', 'continuity_readiness', 'shotDirection', 'shot_direction', 'qualityPass', 'quality_pass'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Checking keyframe prompt quality',
    providerBacked: false,
    manualOnly: false,
  },
  {
  ...
  },
  {
    ...
    label: 'Match World Reference',
    requiredInputs: ['target_node'],
    producedOutputs: ['text', 'targetNode', 'target_node', 'relevantShots', 'relevant_shots', 'assetPack', 'asset_pack', 'selectedWorldReference', 'selected_world_reference', 'referenceAssetKeys', 'reference_asset_keys', 'referenceUsageInstruction', 'reference_usage_instruction', 'matchDecision', 'match_decision', 'matchDiagnostics', 'match_diagnostics'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
    progressLabel: 'Matching world reference',
    providerBacked: true,
    manualOnly: false,
  },
  {
    ...
    requiredInputs: ['target_node'],
    producedOutputs: ['text', 'prompt', 'assetPack', 'asset_pack', 'referenceAssetKeys', 'reference_asset_keys', 'targetNode', 'target_node', 'relevantShots', 'relevant_shots', 'selectedWorldReference', 'selected_world_reference', 'referenceUsageInstruction', 'reference_usage_instruction', 'matchDecision', 'match_decision', 'matchDiagnostics', 'match_diagnostics'],
    artifactRoles: [],
    previewRoles: ['text'],
    recoveryStrategy: 'node_step',
