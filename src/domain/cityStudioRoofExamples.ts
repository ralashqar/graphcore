...
export const ROOF_EXAMPLES=[{name:'Gabled café & apartments',thumbnail:'window-shop'},{name:'L-shaped roof house',thumbnail:'window-shuttered'},{name:'Mansard courtyard',thumbnail:'window-french'}];
