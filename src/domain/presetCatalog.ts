...
const archetypePresets: ArchetypePreset[] = [
  ...
  makeArchetypePreset(
    ...
    'group',
    'House',
    'Dynastic group defined by lineage, heraldry, and political leverage.',
    [
      makeField('role', 'Role', 'text', 0, { defaultValue: 'noble house' }),
      makeField('seat', 'Seat', 'text', 1, { defaultValue: '' }),
      makeField('sigil', 'Sigil', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'faction'],
  ),
  makeArchetypePreset(
    ...
    'group',
    'Faction',
    'Aligned organization with a shared agenda and sphere of influence.',
    [
      makeField('agenda', 'Agenda', 'long_text', 0, { defaultValue: '' }),
      makeField('power_base', 'Power Base', 'text', 1, { defaultValue: '' }),
      makeField('public_face', 'Public Face', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'politics'],
  ),
  makeArchetypePreset(
    'group.cult',
    'group',
    'Cult',
    'Secretive group bound by forbidden doctrine or ritual practice.',
    [
      makeField('doctrine', 'Doctrine', 'long_text', 0, { defaultValue: '' }),
      makeField('hidden_patron', 'Hidden Patron', 'text', 1, { defaultValue: '' }),
      makeField('initiation_cost', 'Initiation Cost', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'occult'],
  ),
  makeArchetypePreset(
    ...
    'group',
    'Guild',
    'Trade or craft organization with internal rules and economic power.',
    [
      makeField('trade', 'Trade', 'text', 0, { defaultValue: '' }),
      makeField('territory', 'Territory', 'text', 1, { defaultValue: '' }),
      makeField('initiation_rite', 'Initiation Rite', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'economy'],
  ),
  makeArchetypePreset(
    ...
    'group',
    'Kingdom',
    'Realm-scale political power with territory, ruler, and succession pressures.',
    [
      makeField('ruler_title', 'Ruler Title', 'text', 0, { defaultValue: 'King' }),
      makeField('capital', 'Capital', 'text', 1, { defaultValue: '' }),
      makeField('succession_rule', 'Succession Rule', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'realm'],
  ),
  makeArchetypePreset(
    ...
    'group',
    'Order',
    'Formal order bound by vows, rites, and a distinct mission.',
    [
      makeField('oath', 'Oath', 'long_text', 0, { defaultValue: '' }),
      makeField('mission', 'Mission', 'text', 1, { defaultValue: '' }),
      makeField('badge', 'Badge', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'order'],
  ),
  makeArchetypePreset(
    ...
    'group',
    'Religion',
    'Belief institution with scripture, clergy, and ritual authority.',
    [
      makeField('core_belief', 'Core Belief', 'long_text', 0, { defaultValue: '' }),
      makeField('sacred_text', 'Sacred Text', 'text', 1, { defaultValue: '' }),
      makeField('ritual_cycle', 'Ritual Cycle', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'group', 'faith'],
  ),
  makeArchetypePreset(
    ...
    'concept',
    'Prophecy',
    'Foretold concept that shapes decisions, fear, and power.',
    [
      makeField('text_excerpt', 'Text Excerpt', 'long_text', 0, { defaultValue: '' }),
      makeField('interpreter', 'Interpreter', 'text', 1, { defaultValue: '' }),
      makeField('fulfillment_condition', 'Fulfillment Condition', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'fate'],
  ),
  makeArchetypePreset(
    ...
    'concept',
    'Belief',
    'Guiding worldview or conviction held by a people, group, or faith.',
    [
      makeField('core_tenet', 'Core Tenet', 'long_text', 0, { defaultValue: '' }),
      makeField('followers', 'Followers', 'text', 1, { defaultValue: '' }),
      makeField('taboo', 'Taboo', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'belief'],
  ),
  makeArchetypePreset(
    'concept.law',
    'concept',
    'Law',
    'Formal rule that governs behavior, legitimacy, or punishment.',
    [
      makeField('jurisdiction', 'Jurisdiction', 'text', 0, { defaultValue: '' }),
      makeField('penalty', 'Penalty', 'text', 1, { defaultValue: '' }),
      makeField('exception', 'Exception', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'governance'],
  ),
  makeArchetypePreset(
    'concept.curse',
    'concept',
    'Curse',
    'Lingering affliction, omen, or supernatural burden.',
    [
      makeField('origin', 'Origin', 'text', 0, { defaultValue: '' }),
      makeField('symptoms', 'Symptoms', 'long_text', 1, { defaultValue: '' }),
      makeField('possible_release', 'Possible Release', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'occult'],
  ),
  makeArchetypePreset(
    'concept.magic_rule',
    'concept',
    'Magic Rule',
    'Explicit constraint or principle that governs how power behaves.',
    [
      makeField('rule_statement', 'Rule Statement', 'long_text', 0, { defaultValue: '' }),
      makeField('cost', 'Cost', 'text', 1, { defaultValue: '' }),
      makeField('loophole', 'Loophole', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'magic'],
  ),
  makeArchetypePreset(
    ...
    'concept',
    'Tradition',
    'Inherited practice or social ritual that carries symbolic weight.',
    [
      makeField('occasion', 'Occasion', 'text', 0, { defaultValue: '' }),
      makeField('participants', 'Participants', 'text', 1, { defaultValue: '' }),
      makeField('meaning', 'Meaning', 'long_text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'culture'],
  ),
  makeArchetypePreset(
    'concept.doctrine',
    'concept',
    'Doctrine',
    'Codified teaching that shapes institutions or ideological conflict.',
    [
      makeField('thesis', 'Thesis', 'long_text', 0, { defaultValue: '' }),
      makeField('opposition', 'Opposition', 'text', 1, { defaultValue: '' }),
      makeField('champion', 'Champion', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'concept', 'ideology'],
  ),
  makeArchetypePreset(
    'event.war',
    'event',
    'War',
    'Sustained military conflict with factions, fronts, and consequences.',
    [
      makeField('belligerents', 'Belligerents', 'text', 0, { defaultValue: '' }),
      makeField('trigger', 'Trigger', 'text', 1, { defaultValue: '' }),
      makeField('current_state', 'Current State', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'conflict'],
  ),
  makeArchetypePreset(
    'event.coronation',
    'event',
    'Coronation',
    'Ceremonial rise to power that can affirm or destabilize legitimacy.',
    [
      makeField('claimant', 'Claimant', 'text', 0, { defaultValue: '' }),
      makeField('witnesses', 'Witnesses', 'text', 1, { defaultValue: '' }),
      makeField('interruption', 'Interruption', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'ceremony'],
  ),
  makeArchetypePreset(
    'event.rebellion',
    'event',
    'Rebellion',
    'Organized uprising against established rule or order.',
    [
      makeField('instigator', 'Instigator', 'text', 0, { defaultValue: '' }),
      makeField('grievance', 'Grievance', 'long_text', 1, { defaultValue: '' }),
      makeField('flashpoint', 'Flashpoint', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'uprising'],
  ),
  makeArchetypePreset(
    'event.betrayal',
    'event',
    'Betrayal',
    'Personal or political turn that fractures trust and alliances.',
    [
      makeField('betrayer', 'Betrayer', 'text', 0, { defaultValue: '' }),
      makeField('betrayed', 'Betrayed', 'text', 1, { defaultValue: '' }),
      makeField('motive', 'Motive', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'intrigue'],
  ),
  makeArchetypePreset(
    'event.ritual',
    'event',
    'Ritual',
    'Formal magical or religious act with symbolic and practical effects.',
    [
      makeField('officiant', 'Officiant', 'text', 0, { defaultValue: '' }),
      makeField('components', 'Components', 'text', 1, { defaultValue: '' }),
      makeField('outcome', 'Outcome', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'occult'],
  ),
  makeArchetypePreset(
    ...
    'event',
    'Catastrophe',
    'Disaster or collapse that permanently changes the world state.',
    [
      makeField('cause', 'Cause', 'text', 0, { defaultValue: '' }),
      makeField('damage_scope', 'Damage Scope', 'text', 1, { defaultValue: '' }),
      makeField('lasting_scar', 'Lasting Scar', 'text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'disaster'],
  ),
  makeArchetypePreset(
    'event.discovery',
    'event',
    'Discovery',
    'Reveal of hidden knowledge, territory, lineage, or power.',
    [
      makeField('discoverer', 'Discoverer', 'text', 0, { defaultValue: '' }),
      makeField('discovered_thing', 'Discovered Thing', 'text', 1, { defaultValue: '' }),
      makeField('why_it_matters', 'Why It Matters', 'long_text', 2, { defaultValue: '' }),
    ],
    ['world', 'event', 'revelation'],
  ),
  makeArchetypePreset(
