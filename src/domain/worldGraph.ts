...
export const worldWikiPresentationMetadataSchema = z.object({
  ...
  narrationPov: worldWikiStringFieldSchema,
  ...
  worldConceptPrompt: worldWikiStringFieldSchema,
  worldConceptAssetKey: worldWikiStringFieldSchema,
  worldConceptVisualJobId: worldWikiStringFieldSchema,
