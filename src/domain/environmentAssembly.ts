...
export const environmentAssemblyPresets: AssemblyGraphPresetDefinition[] = [
  ...
  },
  {
    ...
    summary: 'Large multi-room house with wings, stairs, doors, windows, and layered roofs.',
    build: (graphKey, environmentKey) => ({
      id: `preset-graph-${graphKey}`,
      key: graphKey,
      name: 'Manor House Suite',
      summary: 'Representative multi-room manor house with stairs and facade openings.',
      boundEnvironmentKey: environmentKey ?? null,
      metadata: { presetKey: 'manor_house_suite', macroKey: 'manor' },
      nodes: [
        presetNode('polygon', 'manor_main_outline', { x: 60, y: 170 }, { points: [{ x: -6, y: -4 }, { x: 6, y: -4 }, { x: 6, y: 4 }, { x: -6, y: 4 }] }, 'Main Hall Outline'),
        presetNode('polygon', 'manor_west_outline', { x: 60, y: 320 }, { points: [{ x: -11, y: -3.2 }, { x: -6, y: -3.2 }, { x: -6, y: 3.2 }, { x: -11, y: 3.2 }] }, 'West Wing Outline'),
        presetNode('polygon', 'manor_east_outline', { x: 60, y: 470 }, { points: [{ x: 6, y: -3.2 }, { x: 11, y: -3.2 }, { x: 11, y: 3.2 }, { x: 6, y: 3.2 }] }, 'East Wing Outline'),
        presetNode('room_shell', 'manor_main_shell', { x: 330, y: 170 }, { height: 6.6, wallThickness: 0.24, floorThickness: 0.2 }, 'Main Hall Shell'),
        presetNode('room_shell', 'manor_west_shell', { x: 330, y: 320 }, { height: 4.2, wallThickness: 0.22, floorThickness: 0.18 }, 'West Wing Shell'),
        presetNode('room_shell', 'manor_east_shell', { x: 330, y: 470 }, { height: 4.2, wallThickness: 0.22, floorThickness: 0.18 }, 'East Wing Shell'),
        presetNode('door_opening', 'manor_entry', { x: 590, y: 80 }, { side: 'front', width: 1.5, height: 2.4 }, 'Main Entry'),
        presetNode('door_opening', 'service_entry', { x: 590, y: 180 }, { side: 'front', width: 1.1, height: 2.2 }, 'Service Entry'),
        presetNode('opening_array', 'manor_windows', { x: 590, y: 300 }, { side: 'front', count: 5, spacing: 2.25, width: 1.25, height: 1.4, sillHeight: 0.9 }, 'Main Facade Windows'),
        presetNode('opening_array', 'wing_windows', { x: 590, y: 420 }, { side: 'front', count: 3, spacing: 1.75, width: 1.05, height: 1.15, sillHeight: 0.95 }, 'Wing Windows'),
        presetNode('switchback_stair', 'manor_stair', { x: 590, y: 530 }, { width: 2.4, stepCount: 18, rise: 0.19, tread: 0.28, landingDepth: 2.6 }, 'Grand Stair'),
        presetNode('gable_roof', 'manor_main_roof', { x: 860, y: 170 }, { height: 2.4, eaves: 0.26 }, 'Main Roof'),
        presetNode('hip_roof', 'manor_west_roof', { x: 860, y: 320 }, { height: 1.8, eaves: 0.18 }, 'West Roof'),
        presetNode('hip_roof', 'manor_east_roof', { x: 860, y: 470 }, { height: 1.8, eaves: 0.18 }, 'East Roof'),
        presetNode('environment_output', `${graphKey}.output`, { x: 1100, y: 320 }, {}, 'Environment Output'),
      ],
      edges: [
        presetEdge('main_outline_to_shell', 'manor_main_outline', 'profile', 'manor_main_shell', 'profile'),
        presetEdge('west_outline_to_shell', 'manor_west_outline', 'profile', 'manor_west_shell', 'profile'),
        presetEdge('east_outline_to_shell', 'manor_east_outline', 'profile', 'manor_east_shell', 'profile'),
        presetEdge('main_shell_to_entry_host', 'manor_main_shell', 'solid', 'manor_entry', 'host'),
        presetEdge('main_shell_to_entry_face', 'manor_main_shell', 'wall_faces', 'manor_entry', 'wall_face'),
        presetEdge('west_shell_to_service_host', 'manor_west_shell', 'solid', 'service_entry', 'host'),
        presetEdge('west_shell_to_service_face', 'manor_west_shell', 'wall_faces', 'service_entry', 'wall_face'),
        presetEdge('main_shell_to_windows_host', 'manor_main_shell', 'solid', 'manor_windows', 'host'),
        presetEdge('main_shell_to_windows_face', 'manor_main_shell', 'wall_faces', 'manor_windows', 'wall_face'),
        presetEdge('east_shell_to_windows_host', 'manor_east_shell', 'solid', 'wing_windows', 'host'),
        presetEdge('east_shell_to_windows_face', 'manor_east_shell', 'wall_faces', 'wing_windows', 'wall_face'),
        presetEdge('main_outline_to_roof', 'manor_main_outline', 'profile', 'manor_main_roof', 'profile'),
        presetEdge('main_shell_to_roof_host', 'manor_main_shell', 'solid', 'manor_main_roof', 'host'),
        presetEdge('west_outline_to_roof', 'manor_west_outline', 'profile', 'manor_west_roof', 'profile'),
        presetEdge('west_shell_to_roof_host', 'manor_west_shell', 'solid', 'manor_west_roof', 'host'),
        presetEdge('east_outline_to_roof', 'manor_east_outline', 'profile', 'manor_east_roof', 'profile'),
        presetEdge('east_shell_to_roof_host', 'manor_east_shell', 'solid', 'manor_east_roof', 'host'),
        presetEdge('main_shell_to_output', 'manor_main_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('west_shell_to_output', 'manor_west_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('east_shell_to_output', 'manor_east_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('main_stair_to_output', 'manor_stair', 'solid', `${graphKey}.output`, 'solids'),
  ...
  },
  {
    ...
    summary: 'Central keep, gatehouse arch, tower stairs, and defensive roofs.',
    build: (graphKey, environmentKey) => ({
      id: `preset-graph-${graphKey}`,
      key: graphKey,
      name: 'Fortified Keep',
      summary: 'Large keep and gatehouse composition with towers, arch opening, and stair.',
      boundEnvironmentKey: environmentKey ?? null,
      ...
      nodes: [
        ...
        presetNode('room_shell', 'keep_shell', { x: 330, y: 160 }, { height: 10.5, wallThickness: 0.34, floorThickness: 0.24 }, 'Keep Shell'),
        presetNode('room_shell', 'gatehouse_shell', { x: 330, y: 320 }, { height: 6.8, wallThickness: 0.3, floorThickness: 0.22 }, 'Gatehouse Shell'),
        presetNode('room_shell', 'north_tower_shell', { x: 330, y: 460 }, { height: 12, wallThickness: 0.28, floorThickness: 0.22 }, 'North Tower Shell'),
        presetNode('room_shell', 'south_tower_shell', { x: 330, y: 600 }, { height: 12, wallThickness: 0.28, floorThickness: 0.22 }, 'South Tower Shell'),
        presetNode('arch_opening', 'keep_gate_arch', { x: 590, y: 160 }, { side: 'front', width: 3.8, height: 4.4 }, 'Gate Arch'),
        presetNode('opening_array', 'keep_windows', { x: 590, y: 300 }, { side: 'front', count: 4, spacing: 3.1, width: 0.9, height: 1.6, sillHeight: 1.5 }, 'Keep Windows'),
        presetNode('spiral_stair', 'tower_stair', { x: 590, y: 460 }, { radius: 1.45, stepCount: 32, rise: 0.19 }, 'Tower Stair'),
        presetNode('hip_roof', 'keep_roof', { x: 860, y: 160 }, { height: 2.3, eaves: 0.16 }, 'Keep Roof'),
        presetNode('tower_cap', 'north_tower_cap', { x: 860, y: 460 }, { height: 3.1, taper: 1 }, 'North Tower Cap'),
        presetNode('tower_cap', 'south_tower_cap', { x: 860, y: 600 }, { height: 3.1, taper: 1 }, 'South Tower Cap'),
        presetNode('environment_output', `${graphKey}.output`, { x: 1100, y: 360 }, {}, 'Environment Output'),
      ],
      edges: [
        presetEdge('keep_outline_to_shell', 'keep_outline', 'profile', 'keep_shell', 'profile'),
        presetEdge('gatehouse_outline_to_shell', 'gatehouse_outline', 'profile', 'gatehouse_shell', 'profile'),
        presetEdge('north_outline_to_shell', 'north_tower_outline', 'profile', 'north_tower_shell', 'profile'),
        presetEdge('south_outline_to_shell', 'south_tower_outline', 'profile', 'south_tower_shell', 'profile'),
        presetEdge('gatehouse_shell_to_arch_host', 'gatehouse_shell', 'solid', 'keep_gate_arch', 'host'),
        presetEdge('gatehouse_shell_to_arch_face', 'gatehouse_shell', 'wall_faces', 'keep_gate_arch', 'wall_face'),
        presetEdge('keep_shell_to_windows_host', 'keep_shell', 'solid', 'keep_windows', 'host'),
        presetEdge('keep_shell_to_windows_face', 'keep_shell', 'wall_faces', 'keep_windows', 'wall_face'),
        presetEdge('keep_outline_to_roof', 'keep_outline', 'profile', 'keep_roof', 'profile'),
        presetEdge('keep_shell_to_roof_host', 'keep_shell', 'solid', 'keep_roof', 'host'),
        presetEdge('north_outline_to_cap', 'north_tower_outline', 'profile', 'north_tower_cap', 'profile'),
        presetEdge('north_shell_to_cap_host', 'north_tower_shell', 'solid', 'north_tower_cap', 'host'),
        presetEdge('south_outline_to_cap', 'south_tower_outline', 'profile', 'south_tower_cap', 'profile'),
        presetEdge('south_shell_to_cap_host', 'south_tower_shell', 'solid', 'south_tower_cap', 'host'),
        presetEdge('keep_shell_to_output', 'keep_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('gatehouse_shell_to_output', 'gatehouse_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('north_shell_to_output', 'north_tower_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('south_shell_to_output', 'south_tower_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('tower_stair_to_output', 'tower_stair', 'solid', `${graphKey}.output`, 'solids'),
  ...
  },
  {
    key: 'palace_wing',
    label: 'Palace Wing',
    summary: 'Long formal wing with pavilions, a grand stair, facade rhythm, and mansard roof.',
    build: (graphKey, environmentKey) => ({
      id: `preset-graph-${graphKey}`,
      key: graphKey,
      name: 'Palace Wing',
      summary: 'Representative palace-scale wing with a central entry and formal roofline.',
      boundEnvironmentKey: environmentKey ?? null,
      ...
      nodes: [
        ...
        presetNode('room_shell', 'palace_central_shell', { x: 330, y: 160 }, { height: 7.2, wallThickness: 0.26, floorThickness: 0.22 }, 'Central Wing Shell'),
        presetNode('room_shell', 'palace_left_shell', { x: 330, y: 320 }, { height: 8, wallThickness: 0.26, floorThickness: 0.22 }, 'Left Pavilion Shell'),
        presetNode('room_shell', 'palace_right_shell', { x: 330, y: 480 }, { height: 8, wallThickness: 0.26, floorThickness: 0.22 }, 'Right Pavilion Shell'),
        presetNode('door_opening', 'palace_entry', { x: 590, y: 90 }, { side: 'front', width: 2.2, height: 3.4 }, 'Grand Entry'),
        presetNode('opening_array', 'palace_windows', { x: 590, y: 220 }, { side: 'front', count: 7, spacing: 2.55, width: 1.5, height: 1.6, sillHeight: 1 }, 'Central Facade Windows'),
        presetNode('opening_array', 'pavilion_windows', { x: 590, y: 360 }, { side: 'front', count: 3, spacing: 2.1, width: 1.3, height: 1.5, sillHeight: 1 }, 'Pavilion Windows'),
        presetNode('switchback_stair', 'palace_stair', { x: 590, y: 500 }, { width: 2.8, stepCount: 20, rise: 0.18, tread: 0.3, landingDepth: 2.8 }, 'Grand Stair'),
        presetNode('mansard_roof', 'palace_central_roof', { x: 860, y: 160 }, { height: 2.6, inset: 0.55 }, 'Central Mansard Roof'),
        presetNode('hip_roof', 'palace_left_roof', { x: 860, y: 320 }, { height: 2.1, eaves: 0.18 }, 'Left Pavilion Roof'),
        presetNode('hip_roof', 'palace_right_roof', { x: 860, y: 480 }, { height: 2.1, eaves: 0.18 }, 'Right Pavilion Roof'),
        presetNode('environment_output', `${graphKey}.output`, { x: 1100, y: 320 }, {}, 'Environment Output'),
      ],
      edges: [
        presetEdge('central_outline_to_shell', 'palace_central_outline', 'profile', 'palace_central_shell', 'profile'),
        presetEdge('left_outline_to_shell', 'palace_left_outline', 'profile', 'palace_left_shell', 'profile'),
        presetEdge('right_outline_to_shell', 'palace_right_outline', 'profile', 'palace_right_shell', 'profile'),
        presetEdge('central_shell_to_entry_host', 'palace_central_shell', 'solid', 'palace_entry', 'host'),
        presetEdge('central_shell_to_entry_face', 'palace_central_shell', 'wall_faces', 'palace_entry', 'wall_face'),
        presetEdge('central_shell_to_windows_host', 'palace_central_shell', 'solid', 'palace_windows', 'host'),
        presetEdge('central_shell_to_windows_face', 'palace_central_shell', 'wall_faces', 'palace_windows', 'wall_face'),
        presetEdge('left_shell_to_windows_host', 'palace_left_shell', 'solid', 'pavilion_windows', 'host'),
        presetEdge('left_shell_to_windows_face', 'palace_left_shell', 'wall_faces', 'pavilion_windows', 'wall_face'),
        presetEdge('central_outline_to_roof', 'palace_central_outline', 'profile', 'palace_central_roof', 'profile'),
        presetEdge('central_shell_to_roof_host', 'palace_central_shell', 'solid', 'palace_central_roof', 'host'),
        presetEdge('left_outline_to_roof', 'palace_left_outline', 'profile', 'palace_left_roof', 'profile'),
        presetEdge('left_shell_to_roof_host', 'palace_left_shell', 'solid', 'palace_left_roof', 'host'),
        presetEdge('right_outline_to_roof', 'palace_right_outline', 'profile', 'palace_right_roof', 'profile'),
        presetEdge('right_shell_to_roof_host', 'palace_right_shell', 'solid', 'palace_right_roof', 'host'),
        presetEdge('central_shell_to_output', 'palace_central_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('left_shell_to_output', 'palace_left_shell', 'solid', `${graphKey}.output`, 'solids'),
        presetEdge('right_shell_to_output', 'palace_right_shell', 'solid', `${graphKey}.output`, 'solids'),
