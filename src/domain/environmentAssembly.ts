    ...
    build: (graphKey, environmentKey) => {
      ...
      for (const [index, unit] of unitSpecs.entries()) {
        ...
        nodes.push(
          ...
          presetNode('circulation_zone', stairZoneKey, { x: roomColumn, y: 380 }, { levelIndex: 1, toLevelIndex: 2, roomName: `${unit.label} Stair Hall`, height: 3.2, wallThickness: 0.2, floorThickness: 0.18, fitMode: 'zone_autofit', maxExpandX: 0.45, maxExpandZ: 1.2, allowPartitionPush: false }, `${unit.label} Stair Hall`),
