...
export const OUTPUT_SKILL_REGISTRY: readonly OutputSkill[] = [
  ...
  },
  {
    ...
    description: 'Splits cinematic prompts into timed video blocks with escalation and continuity.',
    category: 'cinematic',
    modality: 'text',
    appliesToNodeTypes: ['text_llm'],
    appliesToPurposes: ['cinematic_entity_selector', 'cinematic_sequence_plan', 'cinematic_block_script'],
    guidance: [
      'Plan a fixed sequence of video blocks where each block has a clear hook, story function, visual escalation, and handoff into the next block.',
      'Keep every video block between 4 and 15 seconds and make each shot timestamped inside that block.',
    ...
    structuredDirectives: { blockRuntime: { minSeconds: 4, maxSeconds: 15 }, fixedFanout: true, continuity: true },
    priority: 97,
    tokenBudget: 300,
    version: '1.0.0',
  ...
  },
  {
    ...
    appliesToPurposes: ['cinematic_block_script', 'cinematic_video_prompt', 'cinematic_block_video'],
    guidance: [
  ...
  },
  {
    ...
    description: 'Builds readable 3x3 or 4x4 storyboard grids for short video blocks.',
    category: 'cinematic',
    modality: 'image',
    appliesToNodeTypes: ['utility_transform', 'image_generation'],
    appliesToPurposes: ['cinematic_storyboard_prompt', 'cinematic_storyboard'],
    guidance: [
      'Create a single storyboard contact sheet: 3x3 for up to 9 panels or 4x4 for 10-15 panels.',
      ...
      'Keep panels visual-only and avoid text overlays, captions, labels, watermarks, or UI unless the user explicitly asked for on-screen text.',
    ],
    avoid: [
    ...
    structuredDirectives: { promptKind: 'storyboard_grid', visualOnly: true, noTextOverlays: true },
    priority: 95,
    tokenBudget: 240,
    version: '1.0.0',
    tags: ['storyboard', 'grid', 'image_prompt', 'visual_only'],
  },
  {
    ...
    guidance: [
      'Reference the storyboard as @Image1 and then use additional @ImageN references only for identity, environment, or hero prop continuity.',
  ...
  },
  {
    ...
    modality: 'text',
    appliesToNodeTypes: ['text_llm', 'video_generation'],
    appliesToPurposes: ['cinematic_sequence_plan', 'cinematic_block_script', 'cinematic_video_prompt', 'cinematic_block_video', 'ugc_script'],
    guidance: [
  ...
  },
  {
    ...
    appliesToPurposes: ['image_prompt', 'video_prompt', 'storyboard_prompt', 'comic_entity_selector', 'comic_atlas_prompt', 'comic_style_atlas', 'comic_page_prompt', 'comic_page', 'cinematic_entity_selector', 'cinematic_storyboard', 'cinematic_block_video'],
    guidance: [
  ...
  },
  {
    ...
    appliesToPurposes: ['image_prompt', 'concept_art_prompt', 'concept_art_image', 'poster_prompt', 'poster_image', 'ebook_cover_prompt', 'ebook_cover_image', 'storyboard_prompt', 'panel_prompt', 'comic_atlas_prompt', 'comic_style_atlas', 'comic_page_prompt', 'comic_page', 'cinematic_storyboard'],
    guidance: [
  ...
  },
  {
    ...
    modality: 'workflow',
    appliesToNodeTypes: ['text_llm', 'image_generation', 'video_generation'],
    appliesToPurposes: ['outline', 'chapter_plan', 'chapter_section_plan', 'chapter_prose', 'chapter_section_prose', 'editor_pass', 'front_back_matter', 'bible_section_plan', 'bible_section', 'bible_assembly', 'story_bible_document_render', 'image_prompt', 'image_reference_selector', 'concept_art_prompt', 'concept_art_image', 'poster_prompt', 'poster_image', 'ebook_cover_prompt', 'ebook_cover_image', 'video_prompt', 'storyboard_prompt', 'ugc_script', 'cinematic_script', 'cinematic_entity_selector', 'cinematic_sequence_plan', 'cinematic_block_script', 'cinematic_storyboard', 'cinematic_block_video', 'comic_entity_selector', 'comic_scene_script', 'comic_page_plan', 'comic_script', 'comic_atlas_prompt', 'comic_style_atlas', 'comic_page_prompt', 'comic_page'],
    guidance: [
