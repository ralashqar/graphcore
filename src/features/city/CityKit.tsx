...
export function CityKit({
  ...
  return (
    <>
      ...
      {!emptyMode && <CityDesignBuildings center={center} zoom={zoom} properties={properties} selectedId={selected?.id} matchIds={matchIds} reduced={reduced} onSelect={onSelect}/> }
