...
export function CityNycRoofDetails({recipe,part,design,commit}:{recipe:StudioRecipe;part?:SculptVolume;design:CityBuildingDesignV3;commit:(r:StudioRecipe)=>void}){
