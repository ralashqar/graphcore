...
import {continuousInputGroup,describeLandChange,recordLandHistory,type LandHistoryEntry} from '../../domain/cityLandHistory';
...
export type LandEditSignal={id:number;label:string;continuous:boolean};
