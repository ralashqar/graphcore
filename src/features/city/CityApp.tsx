...
export function CityApp() {
  ...
  const refresh = useCallback(async () => {
    ...
    try {
      ...
      } else if (!latestPath.current.startsWith("/city/deal/")) {
        setSelected(null);
      }
    } catch (e) {
            ...
            >
              ...
              {dealRoute && linkedDeal && (
                ...
                >
                  ...
                  <button onClick={() => navigate("/city")}>Close deal</button>
                ...
                >
                  {customerEnabled && (
                    <button
                      ...
                      onClick={() => setSheetCollapsed((v) => !v)}
                    >
                      {sheetCollapsed ? "Expand property" : "Minimise property"}
                    </button>
                  )}
                  <div
