...
test('wiki sequence units render a bespoke chapter page', () => {
  ...
  assert.match(worldGraphSource, /shotRefreshIds/)
  ...
  assert.match(worldGraphSource, /Open master graph/)
  assert.match(worldGraphSource, /continuityAnchorCountLabel/)
  assert.match(worldGraphSource, /Preparing continuity refs/)
  assert.match(worldGraphSource, /Continuity refs pending/)
