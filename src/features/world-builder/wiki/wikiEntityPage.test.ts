...
test('wiki sequence units render a bespoke chapter page', () => {
  ...
  assert.match(worldGraphSource, /latestWikiSequenceAnimaticRequest\(outputRequests, entity\.key\)/)
  ...
  assert.match(worldGraphSource, /handleOpenSequenceAnimaticBlockGraph\(sequenceAnimaticPreviewModel, block\)/)
