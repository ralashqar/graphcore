...
test('wiki sequence units render a bespoke chapter page', () => {
  ...
  assert.match(worldGraphSource, /world-wiki-sequence-animatic-continuity-panel/)
  assert.match(worldGraphSource, /Continuity refs/)
  ...
  assert.match(worldGraphSource, /Continuity changed; regeneration recommended/)
  ...
  assert.match(shellCss, /\.world-wiki-sequence-animatic-continuity-panel\s*\{/)
  assert.match(shellCss, /\.world-wiki-sequence-animatic-continuity-card\s*\{/)
  assert.match(shellCss, /\.world-wiki-sequence-animatic-block-continuity\s*\{/)
